            ...
            <div className="p-10 lg:w-10/12  sm:px-10 bg-white rounded-lg shadow-2xl	box-shadow: 0 25px 50px -12px rgb(0 0 0 / 0.25) border">
              ...
              <form className="mt-10" onSubmit={handleSubmit}>
                <div className="flex flex-col space-y-2">
                  ...
                  <div className="registration-page-form-group">
                    <button type="submit" className="w-full py-3 mt-4 bg-blue-800 rounded-sm font-medium text-white uppercase focus:outline-none hover:bg-blue-700 hover:shadow-none">Register</button>
                  </div>
